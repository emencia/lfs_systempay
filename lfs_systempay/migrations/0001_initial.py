...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lfs_systempay_systempaytransaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.Order'])),
            ('uid', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_day', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('lfs_systempay', ['SystempayTransaction'])


    def backwards(self, orm):
        # Deleting model 'SystempayTransaction'
        db.delete_table('lfs_systempay_systempaytransaction')
    ...
    models = {
        ...
        'order.order': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cf7181c8-bfa3-4a4f-9aaa-a1b6cd6a8f54'", 'unique': 'True', 'max_length': '50'}),
